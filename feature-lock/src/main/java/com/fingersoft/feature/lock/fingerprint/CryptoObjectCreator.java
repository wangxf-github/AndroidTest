...
public class CryptoObjectCreator {
            ...
            public void run() {
                try {
                    if (mCryptoObject != null) {
                        ...
                        // of the fingerprint.
                        if (!initCipher()) {
                            Log.e("fingerprint","Failed to init Cipher.");
                        }
                    }
                } catch (Exception e) {
                    Log.e(" Failed to init Cipher, e:" , Log.getStackTraceString(e));
                }
    ...
    private void createKey() {
        ...
        try {
            ...
            Log.d(" Failed to createKey" , Log.getStackTraceString(e));
    ...
    private boolean initCipher() {
        try {
            ...
            Log.d(" Failed to initCipher" , Log.getStackTraceString(e));
            return false;
