...
import com.fingersoft.feature.lock.gesture.GestureLockView.*;
import com.fingersoft.feature.lock.gesture.listener.GestureEventListener;
import com.fingersoft.feature.lock.gesture.listener.GesturePasswordSettingListener;
import com.fingersoft.feature.lock.gesture.listener.GestureUnmatchedExceedListener;
 ...
 * <p/>
 * 关于GestureLockView的边长（n*n）： n * mGestureLockViewWidth + ( n  ) *
 * mMarginBetweenLockView = mWidth ; 得：mGestureLockViewWidth = 3 * mWidth / ( 5
 * * mCount  ) 注：mMarginBetweenLockView = mGestureLockViewWidth * 0.5 ;
 */
public class GestureLockViewGroup extends RelativeLayout {
    ...
    /**
     * GestureLockView的边长 3 * mWidth / ( 5 * mCount )
     */
    ...
    private GestureLockViewLoad gestureLockViewLoad;
    ...
    private void initViews() {
        ...
        if (mGestureLockViews == null) {
            ...
            mGestureLockViewWidth = (int) (3 * mWidth * 1.0f / (5 * mCount));
            //计算每个GestureLockView的间距
            mMarginBetweenLockView = (int) (mGestureLockViewWidth * 0.3);
        ...
        this.gestureLockViewLoad.loadSuccess();
    }
    ...
    //对外公开的一些方法
    public void setGestureLoadListener(GestureLockViewLoad gestureLockViewLoad) {
        this.gestureLockViewLoad = gestureLockViewLoad;
    }
    ...
    public interface GestureLockViewLoad {
        /**
         * gesture页面加载晚完成
         */
        void loadSuccess();
