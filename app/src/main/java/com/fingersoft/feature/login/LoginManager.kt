...
class LoginManager private constructor() {
    ...
    public fun loginOut(userName: String, password: String) {

    }


    public fun checkParams(userName: String, password: String, loginListener: LoginListener) {
    ...
    public fun startLogin(context: Context) {
